        ...
        <div class="be-card" style="margin-top:18px;">
          ...
          <div class="be-card-body">
            ...
            <div class="be-form-group">
              ...
              <div class="be-input" style="opacity:.75;cursor:not-allowed;user-select:none;">{{ $news->author?->name ?? auth()->user()->name ?? 'Admin User' }}</div>
        ...
        <div class="be-card">
          ...
          <div class="be-card-body">
            <div class="be-input" style="opacity:.75;cursor:not-allowed;user-select:none;display:flex;align-items:center;gap:8px;">
              <i class="fas fa-user-circle"></i> {{ $news->author?->name ?? auth()->user()->name ?? 'Admin User' }}
            </div>
